...
public class ClanRepositoryImpl implements ClanRepository {
    ...
    public List<Clan> getAll() {
        ...
        String sql = """
                SELECT
                    ...
                    u.role
                FROM "Cohorte".clan c
                LEFT JOIN "Cohorte".user u ON c.id = u.clan_id
                """;
                ...
                while (rs.next()){
                    ...
                    if (userId != null){
                        ...
                        if ("TL".equalsIgnoreCase(role)) {
                            ...
                            var specialty = rs.getString("user_specialty");
                            if (specialty == null || specialty.isBlank()) specialty = "PROGRAMACION";
                            ...
                            clan.getTls().add(new Tl(
                                    ...
                                    null,
                                    Role.TL,
                                    TlType.valueOf(specialty.trim().toUpperCase())
                            ));

                        } else if ("CODER".equalsIgnoreCase(role)) {
    ...
    public void addUser (UUID clanId , String userId) throws SQLException {
        ...
        try(PreparedStatement psmt = conn.prepareStatement(sql)){
            ...
            if (rows == 0) {
                ...
                throw new SQLException("Error to add user to clan");

            }else {

                System.out.println("User added to clan correctly");
    ...
    public void removeUser (String clanId) throws SQLException{
        ...
        String sql = "UPDATE \"Cohorte\".user SET clan_id = NULL WHERE clan_id = ?";
